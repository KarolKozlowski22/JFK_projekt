...
entry:
  %".2" = load i32, i32* @"x"
  %".3" = bitcast [3 x i8]* @".str.8341731685562686835" to i8*
  %".4" = call i32 (i8*, ...) @"printf"(i8* %".3", i32 %".2")
  %".5" = bitcast [2 x i8]* @".str.4313221362129951564" to i8*
...
entry:
  ...
  store i32 20, i32* %"x"
  %".3" = load i32, i32* %"x"
  %".4" = bitcast [3 x i8]* @".str.8341731685562686835" to i8*
  %".5" = call i32 (i8*, ...) @"printf"(i8* %".4", i32 %".3")
  %".6" = bitcast [2 x i8]* @".str.4313221362129951564" to i8*
