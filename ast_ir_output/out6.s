...
# %bb.0:                                # %entry
	...
	movq	$.str.5170490469680134767, (%rsp)
	movl	$.str.6509151619883873605, %edi
	movl	$.str.5170490469680134767, %esi
	xorl	%eax, %eax
	callq	printf@PLT
...
.str.8700303344908842345:
	...
	.type	.str.5170490469680134767,@object # @.str.5170490469680134767
.str.5170490469680134767:
	.asciz	"Hello, World!"
	.size	.str.5170490469680134767, 14
